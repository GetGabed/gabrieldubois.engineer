    ...
    return (
        <motion.div
            ...
            <div className='w-full flex space-x-5 overflow-x-scroll p-10 snap-mandatory snap-x scrollbar scrollbar-gray-400/20 scrollbar-thumb-primary/80 scrollbar-thin'>
                <ExperienceCard title='Software Developer' company='Genetec' date='May 2023 - Present' bullets={["Developed a feature that searches for Modbus devices connected to a certain range of IP addresses and Ports, retrieves them, and makes them available for the user, dividing by 10 the number of steps required to add a device.", "Added two plugin factories: one for XML string integration and another for regex-based character substitution, expanding software capabilities and compatibility.", "Collaborated with the team to optimize the plugin's responsiveness, resulting in significant improvements to data serialization and a 60% reduction in device polling intervals."]} image="/companies/genetec.png" techs={["devicon-csharp-plain"]} />
