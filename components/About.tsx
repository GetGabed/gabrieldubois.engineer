...
function About({ }: Props) {
    return (
        <div className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-2-7xl px-10 justify-evenly mx-auto items-center'>
            ...
            <motion.div
                ...
                <p className='text-justify'>Hello! My name is Gabriel and I take     pleasure in developing features that will be used and appreciated by a handful of users. My passion for programming started in the mid 2010's as I was trying to understand how the applications, games and websites I've been exploring were made.<br /><br />
