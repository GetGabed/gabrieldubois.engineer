        ...
        <Layout color={color}>
            ...
            <div>
                ...
                <div className="flex">
                    ...
                    <div className="w-2/3 h-96 mr-16 flex flex-col items-center hover:w-3/4 transition-all">
                        <video className={`rounded-full border-2 ${color}`} muted="true" autoplay="true" loop="true" src="/VideoAI.mp4"></video>
